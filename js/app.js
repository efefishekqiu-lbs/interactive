let games = {
    ["streetnheists"]: {
        ...
        description: "Kliv in i en öppen stad inspirerad av klassiska top down actionspel där tempot är högt och faran lurar runt varje hörn Du tar rollen som en orädd karaktär som försöker överleva i en brutal stad fylld av brott kaos och ständiga polisinsatser Utforska gatorna ta dig an uppdrag samla vapen och fly från polisen i intensiva biljakter och explosiva konfrontationer Ju mer uppmärksamhet du väcker desto hårdare blir jakten Kan du hålla dig steget före lagen och skapa ditt eget namn i stadens undre värld",
        faq: `
    ...
    ["parryvsgod"]: {
        ...
        description: "Kliv in i en episk öppen värld där endast de modigaste krigarna överlever Varje boss som dyker upp är en unik utmaning som kräver skicklighet snabbhet och strategi Som spelare tar du rollen som en mästare i parry och attack, redo att möta fruktansvärda gudar i intensiva strider Utforska världen, upptäck hemliga platser och förbered dig på svåra konfrontationer Ju fler bossar du besegrar desto mäktigare blir du Kan du bemästra varje gud och bli den ultimata krigaren i Parry Vs God",
        faq: `
